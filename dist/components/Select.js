...
export function Select({ label, options, value, onChange, placeholder, error, disabled, required, style, }) {
    ...
    const dropdownContent = open && !disabled && typeof document !== 'undefined' ? createPortal(_jsx("div", { ref: dropdownRef, role: "listbox", style: styles({
            position: 'fixed',
            ...
            return (_jsxs("div", { role: "option", "aria-selected": isSelected, onClick: () => {
                    if (!opt.disabled) {
                        selectOption(opt.value);
                    }
                }, onMouseEnter: () => {
                    ...
                    transition: 'background-color 100ms ease',
                            ...
                            whiteSpace: 'nowrap',
                            minWidth: 0,
                        }, children: opt.label }), isSelected && _jsx(Check, { size: 14, style: { color: colors.primary.default, flexShrink: 0 } })] }, opt.value));
        }) }), document.body) : null;
    return (_jsxs("div", { ref: containerRef, style: styles({ marginBottom: spacing.md, ...style }), children: [label && (_jsxs("label", { style: styles({
                    display: 'block',
                    fontSize: ts.label.fontSize,
                    fontWeight: ts.label.fontWeight,
                    color: colors.text.primary,
                    marginBottom: spacing.xs,
                }), children: [label, required && _jsx("span", { style: { color: colors.error.default, marginLeft: spacing.xs }, children: "*" })] })), _jsxs("button", { ref: buttonRef, type: "button", role: "combobox", "aria-expanded": open, "aria-haspopup": "listbox", onClick: () => open ? closeDropdown() : openDropdown(), onKeyDown: handleKeyDown, disabled: disabled, style: styles({
                    width: '100%',
                    ...
                    transition: 'border-color 150ms ease',
                            ...
                            whiteSpace: 'nowrap',
                            minWidth: 0,
                        }, children: displayValue }), _jsx(ChevronDown, { size: 16, style: {
                            color: colors.text.muted,
                            transform: open ? 'rotate(180deg)' : 'rotate(0deg)',
                            transition: 'transform 150ms ease',
                            flexShrink: 0,
                            marginLeft: spacing.xs,
                        } })] }), dropdownContent, error && (_jsx("p", { style: styles({
